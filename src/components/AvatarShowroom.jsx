...
export default function AvatarShowroom({ state, onSelectGender, onGenerate }) {
  ...
  return (
    <section className="relative flex h-full min-h-0 min-w-0 flex-col overflow-hidden rounded-[22px] border border-black/5 bg-white p-2.5 shadow-[0_14px_36px_rgba(25,35,70,.08)] sm:min-h-[760px] sm:rounded-[34px] sm:p-4 lg:glass-panel lg:max-h-[calc(100vh-104px)]">
      ...
      <div
        className="scanline relative flex min-h-0 flex-1 items-center justify-center overflow-hidden rounded-[20px] border border-black/8 sm:min-h-[520px] sm:rounded-[30px] sm:border-2"
        style={{
      ...
      <div className="mt-2 grid shrink-0 gap-2 sm:mt-4 sm:gap-3 xl:grid-cols-[1fr_auto]">
